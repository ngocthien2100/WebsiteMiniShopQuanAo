...
values
  ...
  ('ao-khoac-cardigan', 'Áo khoác Cardigan', 'ao', 'Áo', 349000, 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=900&q=80', 'Mới', array['Nâu','Kem','Xanh rêu'], array['S','M','L'], 'Cardigan mỏng, dễ khoác ngoài khi đi học hoặc đi làm.', 'Áo khoác len mỏng có độ co giãn nhẹ, giữ ấm vừa đủ và tạo cảm giác mềm mại cho outfit hằng ngày.', array['Đi học','Thời tiết mát','Layering'], array['cardigan','len mỏng','layer']),
