...
`Georgia` được dùng cho hero, tiêu đề trang, tiêu đề section và các điểm nhấn editorial. `Verdana` được dùng cho nội dung dài, menu, nút, bảng, form, chatbot và các nút liên hệ để chữ đều, rõ và ổn định trên nhiều thiết bị.
